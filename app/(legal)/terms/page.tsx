...
export const metadata: Metadata = {
  ...
  description:
    "Terms and Conditions for Skyview Plumbing services, SMS communications, and website use.",
  ...
  return (
    <main className="legal-wrap">
      ...
      <article className="legal-card">
        ...
        <p>
          These Terms &amp; Conditions (&ldquo;Terms&rdquo;) govern your use of the Skyview
          Plumbing website, quote form, SMS communications, and plumbing services in Minnesota.
        ...
        <p>
          Skyview Plumbing (&ldquo;Company,&rdquo; &ldquo;we,&rdquo; &ldquo;our,&rdquo; or
        ...
        <p>
          To the fullest extent allowed by applicable law, Skyview Plumbing shall not be
        ...
        <p>
          ...
          form, you agree to receive text messages from Skyview Plumbing related to your
