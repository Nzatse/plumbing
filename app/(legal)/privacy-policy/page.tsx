    ...
    <div>
      ...
      <main className="legal-wrap">
        ...
        <article className="legal-card">
          ...
          <p>
            Thank you for choosing Skyview Plumbing LLC (&ldquo;Company,&rdquo; &ldquo;we,&rdquo;
        ...
        <ul>
          ...
          <p>
            ...
            Skyview Plumbing LLC, you agree to receive text messages regarding appointments, service
          ...
          <ul>
            <li>
              <strong>Skyview Plumbing LLC</strong>
            </li>
